...
icon = pygame.image.load(base_path + "/images/playerPurple/barrackPurple.png")
pygame.display.set_icon(icon)

ImgNeutral = list(range(6))
ImgNeutral[0] = pygame.image.load(base_path + "/images/empty.png")
ImgNeutral[1] = pygame.image.load(base_path + "/images/black.png")
ImgNeutral[2] = pygame.image.load(base_path + "/images/emptyNext.png")
ImgNeutral[3] = pygame.image.load(base_path + "/images/emptyBack.png")
ImgNeutral[4] = pygame.image.load(base_path + "/images/en.png")
ImgNeutral[5] = pygame.image.load(base_path + "/images/de.png")

Img_building = list(range(8))
Img_building[0] = pygame.image.load(base_path + "/images/playerBlue/baseBlue.png")
Img_building[1] = pygame.image.load(base_path + "/images/playerBlue/barrackBlue.png")
Img_building[2] = pygame.image.load(base_path + "/images/playerPurple/basePurple.png")
Img_building[3] = pygame.image.load(base_path + "/images/playerPurple/barrackPurple.png")
Img_building[4] = pygame.image.load(base_path + "/images/playerOrange/baseOrange.png")
Img_building[5] = pygame.image.load(base_path + "/images/playerOrange/barrackOrange.png")
Img_building[6] = pygame.image.load(base_path + "/images/playerGreen/baseGreen.png")
Img_building[7] = pygame.image.load(base_path + "/images/playerGreen/barrackGreen.png")

Img_laser = list(range(20))
Img_laser[0] = pygame.image.load(base_path + "/images/laser0.png")
Img_laser[1] = pygame.image.load(base_path + "/images/laser90.png")
Img_laser[2] = pygame.image.load(base_path + "/images/laser180.png")
Img_laser[3] = pygame.image.load(base_path + "/images/laser270.png")
Img_laser[4] = pygame.image.load(base_path + "/images/playerBlue/laserB0.png")
Img_laser[5] = pygame.image.load(base_path + "/images/playerBlue/laserB90.png")
Img_laser[6] = pygame.image.load(base_path + "/images/playerBlue/laserB180.png")
Img_laser[7] = pygame.image.load(base_path + "/images/playerBlue/laserB270.png")
Img_laser[8] = pygame.image.load(base_path + "/images/playerPurple/laserP0.png")
Img_laser[9] = pygame.image.load(base_path + "/images/playerPurple/laserP90.png")
Img_laser[10] = pygame.image.load(base_path + "/images/playerPurple/laserP180.png")
Img_laser[11] = pygame.image.load(base_path + "/images/playerPurple/laserP270.png")
Img_laser[12] = pygame.image.load(base_path + "/images/playerOrange/laserO0.png")
Img_laser[13] = pygame.image.load(base_path + "/images/playerOrange/laserO90.png")
Img_laser[14] = pygame.image.load(base_path + "/images/playerOrange/laserO180.png")
Img_laser[15] = pygame.image.load(base_path + "/images/playerOrange/laserO270.png")
Img_laser[16] = pygame.image.load(base_path + "/images/playerGreen/laserG0.png")
Img_laser[17] = pygame.image.load(base_path + "/images/playerGreen/laserG90.png")
Img_laser[18] = pygame.image.load(base_path + "/images/playerGreen/laserG180.png")
Img_laser[19] = pygame.image.load(base_path + "/images/playerGreen/laserG270.png")

Img_tower = list(range(5))
Img_tower[0] = pygame.image.load(base_path + "/images/tower.png")
Img_tower[1] = pygame.image.load(base_path + "/images/playerBlue/towerBlue.png")
Img_tower[2] = pygame.image.load(base_path + "/images/playerPurple/towerPurple.png")
Img_tower[3] = pygame.image.load(base_path + "/images/playerOrange/towerOrange.png")
Img_tower[4] = pygame.image.load(base_path + "/images/playerGreen/towerGreen.png")

Img_boy = list(range(4))
Img_boy[0] = pygame.image.load(base_path + "/images/playerBlue/boyBlue.png")
Img_boy[1] = pygame.image.load(base_path + "/images/playerPurple/boyPurple.png")
Img_boy[2] = pygame.image.load(base_path + "/images/playerOrange/boyOrange.png")
Img_boy[3] = pygame.image.load(base_path + "/images/playerGreen/boyGreen.png")

Img_archer = list(range(4))
Img_archer[0] = pygame.image.load(base_path + "/images/playerBlue/bogiBlue.png")
Img_archer[1] = pygame.image.load(base_path + "/images/playerPurple/bogiPurple.png")
Img_archer[2] = pygame.image.load(base_path + "/images/playerOrange/bogiOrange.png")
Img_archer[3] = pygame.image.load(base_path + "/images/playerGreen/bogiGreen.png")

Img_knight = list(range(4))
Img_knight[0] = pygame.image.load(base_path + "/images/playerBlue/knightBlue.png")
Img_knight[1] = pygame.image.load(base_path + "/images/playerPurple/knightPurple.png")
Img_knight[2] = pygame.image.load(base_path + "/images/playerOrange/knightOrange.png")
Img_knight[3] = pygame.image.load(base_path + "/images/playerGreen/knightGreen.png")

Img_info = list(range(15))
Img_info[0] = pygame.image.load(base_path + "/images/info/enBase.png")
Img_info[1] = pygame.image.load(base_path + "/images/info/deBase.png")
Img_info[2] = pygame.image.load(base_path + "/images/info/enBarrack.png")
Img_info[3] = pygame.image.load(base_path + "/images/info/deBarrack.png")
Img_info[4] = pygame.image.load(base_path + "/images/info/enBoy.png")
Img_info[5] = pygame.image.load(base_path + "/images/info/deBoy.png")
Img_info[6] = pygame.image.load(base_path + "/images/info/enArcher.png")
Img_info[7] = pygame.image.load(base_path + "/images/info/deArcher.png")
Img_info[8] = pygame.image.load(base_path + "/images/info/enKnight.png")
Img_info[9] = pygame.image.load(base_path + "/images/info/deKnight.png")
Img_info[10] = pygame.image.load(base_path + "/images/info/enLaser.png")
Img_info[11] = pygame.image.load(base_path + "/images/info/deLaser.png")
Img_info[12] = pygame.image.load(base_path + "/images/info/enTower.png")
Img_info[13] = pygame.image.load(base_path + "/images/info/deTower.png")
Img_info[14] = pygame.image.load(base_path + "/images/info/black.png")
...
SelectionImg[0] = pygame.image.load(base_path + "/images/selection/selection.png")
SelectionImg[1] = pygame.image.load(base_path + "/images/selection/selectionAttack.png")
SelectionImg[2] = pygame.image.load(base_path + "/images/selection/selectionRun.png")
SelectionImg[3] = pygame.image.load(base_path + "/images/selection/selectionSpecial.png")
SelectionImg[4] = pygame.image.load(base_path + "/images/selection/selectionInfo.png")
SelectionImg[5] = pygame.image.load(base_path + "/images/selection/selection2.png")
SelectionImg[6] = pygame.image.load(base_path + "/images/selection/selection2Archer.png")
SelectionImg[7] = pygame.image.load(base_path + "/images/selection/selection2Knight.png")

NextImg = list(range(5))
NextImg[0] = pygame.image.load(base_path + "/images/emptyNext.png")
NextImg[1] = pygame.image.load(base_path + "/images/playerBlue/nextBlue.png")
NextImg[2] = pygame.image.load(base_path + "/images/playerPurple/nextPurple.png")
NextImg[3] = pygame.image.load(base_path + "/images/playerOrange/nextOrange.png")
NextImg[4] = pygame.image.load(base_path + "/images/playerGreen/nextGreen.png")
